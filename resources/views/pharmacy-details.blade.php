...
@section('content')
   ...
   <main>
      ...
      <div class="breadcrumb__area theme-bg-1 p-relative z-index-11 pt-95 pb-95">
         <div class="breadcrumb__thumb" data-background="{{ asset('assets/imgs/bg/breadcrumb-pharmacy.jpg') }}"></div>
         <div class="container">
            ...
            <div class="row align-items-center">
               <div class="col-xxl-6 col-lg-6">
                  <div class="product__details-thumb-wrapper d-sm-flex align-items-start mr-50">
                     <div class="product__details-thumb-tab mr-20" style="width: 25%;">
                        <nav>
                     ...
                     <div class="product__details-thumb-tab-content" style="width: 100%;">
                           ...
                           <div class="product__details-action mb-35">
                              <div class="product__quantity">
                                 <div class="product-quantity-wrapper">
                                    <button class="cart-minus" type="button"><i class="fa-light fa-minus"></i></button>
                                    <input class="cart-input" name="quantity" type="text" value="1" min="1">
                                    <button class="cart-plus" type="button"><i class="fa-light fa-plus"></i></button>
                                 </div>
                              </div>
                                 ...
                                 <div class="latest-comments mb-50">
                                    <ul>
                                       ...
                                       <li>
                                          <div class="comments-box d-flex">
                                             <div class="comments-avatar mr-10">
                                                <img src="{{ asset('assets/imgs/user/user-02.png') }}" alt="">
                                             </div>
                                             <div class="comments-text">
                                                <div
                                                   class="comments-top d-sm-flex align-items-start justify-content-between mb-5">
                                       ...
                                       <li>
                                          <div class="comments-box d-flex">
                                             <div class="comments-avatar mr-10">
                                                <img src="{{ asset('assets/imgs/user/user-03.png') }}" alt="">
                                             </div>
                                             <div class="comments-text">
                                                <div
                                                   class="comments-top d-sm-flex align-items-start justify-content-between mb-5">
