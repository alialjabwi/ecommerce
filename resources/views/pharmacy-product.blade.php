                                      ...
                                      <div class="product-item">
                                          ...
                                          <div class="product-action-item">
                                            <form action="{{ route('cart.store') }}" method="POST">
                                              ...
                                              <a type="button" class="product-action-btn" href="{{ route('products.show', $product->id) }}">
                                             ...
                                             @if ($favorites->contains($product->id))
                                                <form action="{{ route('favorites.destroy', $product->id) }}" method="POST">
                                                   ...
                                                   <input type="hidden" name="product_id" value="{{ $product->id }}">
                                                   <button type="submit" class="product-action-btn">
                                                         <svg width="28" height="26" viewBox="0 0 24 24" fill="#eb753b" xmlns="http://www.w3.org/2000/svg">
                                                            <path d="M12 21.35l-1.45-1.32C5.4 15.36 2 12.28 2 8.5 2 5.42 4.42 3 7.5 3c1.74 0 3.41.81 4.5 2.09C13.09 3.81 14.76 3 16.5 3 19.58 3 22 5.42 22 8.5c0 3.78-3.4 6.86-8.55 11.54L12 21.35z"/>
                                                         </svg>
                                                         <span class="product-tooltip">Delete From Wishlist</span>
                                                   </button>
                                                </form>
                                             @else
                                          ...
                                          <div class="product-content">
                                              ...
                                              <div class="product-price">
                                                  <span class="product-old-price"><del>${{ number_format($product->price + 5, 2) }}</del></span>
